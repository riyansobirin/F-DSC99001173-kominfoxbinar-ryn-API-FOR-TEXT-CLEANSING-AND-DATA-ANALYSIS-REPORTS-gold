...
# Mengubah karakter menjadi lowercase
def lowercase(s):
    return s.lower()
...
db = sqlite3.connect('C:/Users/Asus/Documents/Project/database.db', check_same_thread = False)
...
# Mengganti kata-kata yang tidak baku menjadi kata yang baku
...
# Menghilangkan kata-kata abusive
